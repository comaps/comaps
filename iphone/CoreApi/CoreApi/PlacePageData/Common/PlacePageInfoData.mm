  ...
  if (self)
  {
    ...
    rawData.ForEachMetadataReadable([&](MetadataID metaID, std::string const &value)
    {
      ...
      case MetadataID::FMD_OPEN_HOURS:
        ...
        break;
      case MetadataID::FMD_CHECK_DATE: _checkDate = ParseDateString(ToNSString(value)); break;
      case MetadataID::FMD_CHECK_DATE_OPEN_HOURS: _checkDateOpeningHours = ParseDateString(ToNSString(value)); break;
      ...
      case MetadataID::FMD_CAPACITY:
        _capacity =
            [[[NSAttributedString localizedAttributedStringWithFormat:NSLocalizedAttributedString(@"capacity", nil),
                                                                      [ToNSString(value) intValue]]
                attributedStringByInflectingString] string];
        break;
      case MetadataID::FMD_ROOMS:
        _rooms = [[[NSAttributedString localizedAttributedStringWithFormat:NSLocalizedAttributedString(@"rooms", nil),
                                                                           [ToNSString(value) intValue]]
            attributedStringByInflectingString] string];
        break;
      ...
      case MetadataID::FMD_CAPACITY_DISABLED:
        if (value == "yes")
          ...
          _capacityDisabled = [[[NSAttributedString
              localizedAttributedStringWithFormat:NSLocalizedAttributedString(@"capacity_disabled", nil),
                                                  [ToNSString(value) intValue]] attributedStringByInflectingString]
              string];
        break;
      case MetadataID::FMD_CAPACITY_CHARGING:
        if (value == "yes")
          ...
          _capacityCharging = [[[NSAttributedString
              localizedAttributedStringWithFormat:NSLocalizedAttributedString(@"capacity_charging", nil),
                                                  [ToNSString(value) intValue]] attributedStringByInflectingString]
              string];
        break;
      ...
      case MetadataID::FMD_NETWORK:
        ...
        break;
      case MetadataID::FMD_POPULATION:
        _population =
            [[[NSAttributedString localizedAttributedStringWithFormat:NSLocalizedAttributedString(@"population", nil),
                                                                      [ToNSString(value) intValue]]
                attributedStringByInflectingString] string];
        break;
