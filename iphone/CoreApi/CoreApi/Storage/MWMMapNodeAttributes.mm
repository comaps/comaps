...
- (instancetype)initWithCoreAttributes:(storage::NodeAttrs const &)attributes
  ...
  if (self) {
    ...
    double progressCurrent = attributes.m_downloadingProgress.m_bytesDownloaded;
    double progressGoal = attributes.m_downloadingProgress.m_bytesTotal;
    _downloadingSize = progressGoal > 0 ? (progressCurrent/progressGoal) : 0;
