...
struct MapCustomButton: View {
    ...
    @AppStorage(Settings.userDefaultsKeyMapCustomButtonKind) private var kind: MapCustomButton.Kind = .information
        ...
        Button {
            ...
            Label {
                ...
                kind.image
                    ...
                    .foregroundStyle((hasBadge ? Color.BaseColors.red : .secondary), .secondary)
