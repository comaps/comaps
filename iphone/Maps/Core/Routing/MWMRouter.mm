...
- (instancetype)initRouter
{
  ...
  if (self)
  {
    ...
    [NSNotificationCenter.defaultCenter
        addObserverForName:@"RoutingOptionsChanged"
                    object:nil
                     queue:nil
                usingBlock:^(NSNotification *_Nonnull notification) { [MWMRouter updateRoute]; }];
  }
  return self;
}
