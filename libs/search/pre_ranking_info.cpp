...
std::string DebugPrint(PreRankingInfo const & info)
{
  ...
  os << std::boolalpha << "PreRankingInfo " << "{ m_distanceToPivot: " << info.m_distanceToPivot
     << ", m_tokenRanges [ ";
  ...
  os << " ]" << ", m_rank: " << static_cast<int>(info.m_rank)
     << ", m_popularity: " << static_cast<int>(info.m_popularity) << ", m_type: " << DebugPrint(info.m_type)
     << ", m_allTokensUsed: " << info.m_allTokensUsed << ", m_exactMatch: " << info.m_exactMatch
