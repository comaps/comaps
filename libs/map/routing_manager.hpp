...
private:
  ...
  void CollectFeaturesAlongRoute(std::vector<routing::RouteSegment> const & segments, m2::PointD const & startPt, uint32_t featureType, std::vector<m2::PointD> & outPoints);
  ...
  void CollectTrafficLights(std::vector<routing::RouteSegment> const & segments, m2::PointD const & startPt, std::vector<m2::PointD> & trafficLights);
  void CreateTrafficLightMarks(std::vector<m2::PointD> && trafficLights);
