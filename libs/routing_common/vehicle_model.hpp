...
enum class HighwayType : uint16_t
{
  ...
  ManMadePier = 119,
  // HighwayConstruction and its subtypes are needed for traffic message decoding
  HighwayConstruction = 162,
  HighwayConstructionMotorway = 1632,
  HighwayConstructionMotorwayLink = 1633,
  HighwayConstructionTrunk = 1634,
  HighwayConstructionTrunkLink = 1635,
  HighwayConstructionPrimary = 1636,
  HighwayConstructionPrimaryLink = 1637,
  HighwayConstructionSecondary = 1638,
  HighwayConstructionSecondaryLink = 1639,
  HighwayConstructionTertiary = 1640,
  HighwayConstructionTertiaryLink = 1641,
  HighwayConstructionResidential = 1642,
  HighwayConstructionUnclassified = 1643,
  HighwayConstructionService = 1644,
  HighwayConstructionLivingStreet = 1645,
  HighwayConstructionRoad = 1646,
  HighwayConstructionTrack = 1647,
