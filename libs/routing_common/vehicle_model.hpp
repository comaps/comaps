...
enum class HighwayType : uint16_t
{
  ...
  HighwayConstructionMotorway = 789,
  HighwayConstructionMotorwayLink = 790,
  HighwayConstructionTrunk = 791,
  HighwayConstructionTrunkLink = 792,
  HighwayConstructionPrimary = 793,
  HighwayConstructionPrimaryLink = 794,
  HighwayConstructionSecondary = 795,
  HighwayConstructionSecondaryLink = 796,
  HighwayConstructionTertiary = 797,
  HighwayConstructionTertiaryLink = 798,
  HighwayConstructionResidential = 799,
  HighwayConstructionUnclassified = 800,
  HighwayConstructionService = 801,
  HighwayConstructionLivingStreet = 802,
  HighwayConstructionRoad = 803,
  HighwayConstructionTrack = 804,
