...
{
#ifdef OMIM_OS_IPHONE
  return [Bridge verifyRegionsFileWithRawPublicKey:[NSData dataWithBytes:pubKey length:32]
                                           rawData:[NSData dataWithBytes:msg length:msgSize]
                                      rawSignature:[NSData dataWithBytes:sig length:64]];
#else
