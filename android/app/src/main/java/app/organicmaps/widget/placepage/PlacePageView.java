...

{
  ...
  private void refreshDetails()
  {
    ...
    final String population = populationFormat.format(Long.parseLong(mMapObject.getMetadata(Metadata.MetadataType.FMD_POPULATION)));
      refreshMetadataOrHide(!TextUtils.isEmpty(population) ? getContext().getResources().getQuantityString(R.plurals.population, (int)Long.parseLong(population), Long.parseLong(population)) : "", mPopulation, mTvPopulation);
