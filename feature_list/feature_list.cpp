...
public:
  ...
  void Process(FeatureType & f, map<uint32_t, base::GeoObjectId> const & ft2osm)
  {
    ...
    vector<string> columns = {
        ...
        contact_instagram, contact_twitter, contact_vk,    contact_line, wikimedia_commons, panoramax};
...
void PrintHeader()
{
  vector<string> columns = {"id",              "old_id",       "lat",        "lon",              "mwm",
                            ...
                            "contact_twitter", "contact_vk",   "contact_line", "wikimedia_commons", 'panoramax'};
